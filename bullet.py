...
class Bullet(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        self.rect.midtop = ai_game.ship.rect.midtop  # taki samo położenie midtop pocisku co statku

        # Położenie pocisku jest zdefiniowane za pomocą wartości zmiennoprzecikowej.
        self.y = float(self.rectr.y)

    def update(self):
        """Poruszanie pociskiem po ekranie"""
        # Uaktualnienie pozłożenia pocisku.
        self.y -= self.settings.bullet_speed
        # Uauktualnienie [NADPISANIE] położenia prostokąta pocisku.
        self.rect.y = self.y
