...
class Ship():
    ...
    def __init__(self, ai_game):
        """Inicjalizacja staku kosmicznego i jego położenia początkowego"""
    ...
    def update(self):
        """
        Uaktualnienie położenia statku na podstawie opci wskazującej 
        na jego ruch.
        """
    ...
    def blitme(self):
        """Narysowanie statku kosmicznego w jego aktualnym położeniu."""
